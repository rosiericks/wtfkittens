...
class KittensControllerTest < ActionController::TestCase
  ...
  test "should create kitten" do
    assert_difference('Kitten.count') do
      post :create, kitten: { description: @kitten.description, name: @kitten.name, picture: @kitten.picture }
    end
  ...
  test "should update kitten" do
    patch :update, id: @kitten, kitten: { description: @kitten.description, name: @kitten.name, picture: @kitten.picture }
    assert_redirected_to kitten_path(assigns(:kitten))
  end
